# cryptoguard:V03.10.04 General Usage
## Raw Arguments
...
| -s | file/files/*.in/dir/ClassPathString | Required: The source to be scanned use the absolute path or send all of the source files via the file input.in ex. find -type f *.java >> input.in. |
...
| -exp | Flag | View the experiment based results. |
...
| -L | Flag | Enable logging to the console. |
