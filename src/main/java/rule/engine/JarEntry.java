...
public class JarEntry implements EntryHandler {
    ...
    public void Scan(EnvironmentInformation generalInfo) throws ExceptionHandler {
        ...
        for (RuleChecker ruleChecker : CommonRules.ruleCheckerList) {
            ...
            ruleChecker.checkRule(EngineType.JAR, generalInfo.getSource(), generalInfo.getDependencies(), generalInfo.getSourcePaths(), generalInfo.getOutput(), generalInfo.getMain(), generalInfo.getAndroidHome(), generalInfo.getJavaHome());
        }
