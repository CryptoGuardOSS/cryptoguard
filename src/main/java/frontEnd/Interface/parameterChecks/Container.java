 ...
 *
 * <p>Container</p>
 * <p>The "Builder Class" to interface with CryptoGuard</p>
 * This class allows developers to integrate more freely with the internals with a builder pattern type of approach.
 */
public class Container {
    ...
    public String build() throws ExceptionHandler {
        ...
        EnvironmentInformation info = Core.paramaterCheck(
    ...
    public String toString() {
        return "\"Container\": {" +
                "\"javaHome\":" + prep(this.getJavaHome()) + "," +
                "\"androidHome\":" + prep(this.getAndroidHome()) + "," +
                "\"debuggingLevel\":" + prep(this.getDebuggingLevel()) + "," +
                "\"listing\":" + prep(this.getListing()) + "," +
                "\"engineType\":" + prep(this.getEngineType()) + "," +
                "\"sourceValues\":" + prep(this.getSourceValues()) + "," +
                "\"dependencyValues\":" + prep(this.getDependencyValues()) + "," +
                "\"overwriteOutFile\":" + prep(this.getOverwriteOutFile()) + "," +
                "\"outFile\":" + prep(this.getOutFile()) + "," +
                "\"mainFile\":" + prep(this.getMainFile()) + "," +
                "\"prettyPrint\":" + prep(this.getPrettyPrint()) + "," +
                "\"showTimes\":" + prep(this.getShowTimes()) + "," +
                "\"streaming\":" + prep(this.getStreaming()) + "," +
                "\"displayHeuristics\":" + prep(this.getDisplayHeuristics()) + "," +
                "\"scanningDepth\":" + prep(this.getScanningDepth()) + "," +
                "\"packageName\":" + prep(this.getPackageName())+
                "}";
    }
    //endregion
}