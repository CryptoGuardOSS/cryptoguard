    ...
    public String handleOutput() throws ExceptionHandler {
        ...
        try {
            ...
            for (AnalysisIssue in : super.getCollection()) {
                BugInstanceType marshalled = frontEnd.MessagingSystem.routing.outputStructures.common.ScarfXML.marshalling(in, super.getCwes(), super.getSource().getFileOutName(), numOfBugs++, super.getSource().getBuildId(), super.getSource().getxPath());
